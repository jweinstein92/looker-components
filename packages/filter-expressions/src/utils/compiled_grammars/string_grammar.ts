...
function peg$parse(input, options) {
 ...
 return {
  ...
  var peg$f5 = function(sequence) {
          return {
              type:'match',
              value: [sequence.join('')]
          }
      };
  var peg$f6 = function(sequence) {
       return {
           type:'match',
           value: [sequence]
       }
 ...
 return {
  ...
  var peg$f12 = function(str) { return str ? str.trim():str};
  var peg$f13 = function(chars) {
     return '"' + chars.join("") + '"'
   };
  var peg$f14 = function(chars) {return chars.join('') };
  var peg$f15 = function(symbol) { return symbol};
